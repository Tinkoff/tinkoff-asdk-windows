...
namespace Tinkoff.Acquiring.Sample
{
    ...
    {
        public static readonly string CustomerKey = "user-key";
        public static ObservableCollection<BasketItem> Basket = new ObservableCollection<BasketItem>();
        ...
        /// </summary>
        /// <param name="sender">The Frame which completed navigation</param>
        /// <param name="e">Details about the navigation complete</param>
