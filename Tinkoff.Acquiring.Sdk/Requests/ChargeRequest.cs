...
{
    /// <summary>
    /// Осуществляет рекуррентный (повторный) платеж — списание денежных средств без подтверждения со счета банковской карты Покупателя.
    /// </summary>
    sealed class ChargeRequest : AcquiringRequest
    {
        /// <summary>
