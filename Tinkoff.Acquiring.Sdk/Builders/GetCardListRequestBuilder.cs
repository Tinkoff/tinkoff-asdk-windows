...
{
    class GetCardListRequestBuilder : AcquiringRequestBuilder<GetCardListRequest>
    {
        #region Ctor

        public GetCardListRequestBuilder(string password, string terminalKey, Journal journal)
